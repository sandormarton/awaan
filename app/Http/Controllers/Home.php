...
//
//        foreach ($this->data["catchup_items"] as $item){
//            print_r($item->catchup_img);
//            print_r("\n");
//            /*$file = $item->catchup_img;
//            $newfile = $_SERVER['DOCUMENT_ROOT'] . '/tt/'.$item->id.".jpg";
//
...
//                echo "Copy failed. \n";
//            }*/
//            /*$content = file_get_contents($item->catchup_img);
//
//            $fp = fopen('/tt/'.$item->id.".jpg", "w");
//            fwrite($fp, $content);
//            fclose($fp);*/
//
//            $ch = curl_init();
//
//            curl_setopt($ch, CURLOPT_URL, $item->catchup_img);
//            curl_setopt($ch, CURLOPT_HEADER, 0);
//            curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1 );
//
//            $html = curl_exec($ch);
//
//            $fh = fopen('/tt/'.$item->id.".jpg", 'w') or die("can't open file");
//            fwrite($fh, $html);
//            fclose($fh);
//
//            curl_close($ch);
...
//        dd($this->data["latest"]);
    ...
    public function make_shorturl(Request $request){
       ...
       public function WeKnow(){
		$api = new ApiRequest();
         $this->data["most_viewed_categories"] ="";
         $this->data["most_viewed_shows"] ="";
        $this->data["most_viewed_categories"] = $api->getMostViewedCategories();
        $this->data["most_viewed_shows"] = $api->getMostViewedShows();
