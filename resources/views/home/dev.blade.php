    ...
    <div class="shareModal" id="shareModal">
        <div class="shareModal-body">
            ...
            <ul class="footer-sm-ul">
                <li><a href="#" title="Facebook" class="share_fb" target="_blank"  rel="noopener noreferrer"><img  src="images/icon-sm-facebook.png" alt="Facebook" /></a></li>
                <li><a href="#" title="Twitter" class="share_twitter" target="_blank"  rel="noopener noreferrer"><img src="images/icon-sm-twitter.png" alt="Twitter" /></a></li>
