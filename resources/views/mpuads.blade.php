...
if(isset($ads) and $ads != false){
    ...
    if($ads->channel_type == 'all' and $ads->ad_type== 'double_click'  and $ads->companion == 1){
        ...
        echo '<iframe src="http://admin.mangomolo.com/analytics/index.php/dfp?size=300&url='.$google_doubleclick.'" width="300" height="250" scrolling="no" frameborder="0" style="border: 0;"></iframe>';
    }else{
