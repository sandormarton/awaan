...
@section('title', trans('content.videos_favorites.favvideosfilms'))
...
<div class="favorite-video-list-wrapper">
    <div class="container">
        @if(!empty($favorites_films_rows))
            <h3 class="content-title">{{ trans('content.videos_favorites.favvideosfilms') }}</h3>
            <div class="row">
                <?php echo $favorites_films_rows?>
            </div><!-- ROW [END]	-->
        @else
