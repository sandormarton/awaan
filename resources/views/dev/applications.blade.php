			...
			<div id="Smarttvbanner-carousel" class="Smarttvbanner-carousel carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img src="{{asset("images/smart-tv-banner-1.jpg")}}" class="slide-img img-responsive">
						<div class="carousel-caption">
							<div class="caption-image" data-animation="animated flipInX">
								<img src="{{asset("images/logo-medium.png")}}" class="caption-img" />
							</div>
					...
					<div class="item">
						<img src="{{asset("images/smart-tv-banner-2.jpg")}}" class="slide-img img-responsive">
						<div class="carousel-caption">
							<div class="caption-image" data-animation="animated flipInX">
								<img src="{{asset("images/logo-medium.png")}}" class="caption-img" />
							</div>
					...
					<div class="item">
						<img src="{{asset("images/smart-tv-banner-3.jpg")}}" class="slide-img img-responsive">
						<div class="carousel-caption">
							<div class="caption-image" data-animation="animated flipInX">
								<img src="{{asset("images/logo-medium.png")}}" class="caption-img" />
							</div>
			...
			<div class="smarttv-content-wrapper">
				...
				<div class="container">
					<div class="smarttv-content-cotnainer">
						...
						<img src="{{asset("images/smart-samsung-tvs.png")}}" class="img-responsive center-block" />
			...
			<div class="smarttv-tvtype-wrapper">
				...
				<div class="container">
					<div class="smarttv-tvtype-cotnainer">
						...
						<img src="{{asset("images/logo-medium.png")}}" class="img-repsonsive" />
						...
						<ul class="list-inline smarttv-tvtype-list">
							<li><a href="#"><img src="{{asset("images/smarttv-appletv.png")}}" class="img-responsive" /></a></li>
							<li><a href="#"><img src="{{asset("images/smarttv-samsungtv.png")}}" class="img-responsive" /></a></li>
							<li><a href="#"><img src="{{asset("images/smarttv-humaxtv.png")}}" class="img-responsive" /></a></li>
							<li><a href="#"><img src="{{asset("images/smarttv-chromecasttv.png")}}" class="img-responsive" /></a></li>
							<li><a href="#"><img src="{{asset("images/smarttv-iostv.png")}}" class="img-responsive" /></a></li>
							<li class="border-no"><a href="#"><img src="{{asset("images/smarttv-androidtv.png")}}" class="img-responsive" /></a></li>
						</ul>
