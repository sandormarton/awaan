...
@section('title', 'Video on Demand - AWAAN Register')
@section('social_header_meta')
    @include('include.custom_social_header',[
        'current_title'=>"Video on Demand - AWAAN Register",
        'current_description'=>"Video on Demand - AWAAN Register",
    ])
@endsection
@section('main-content')
    <h1 style="display: none;">Awaan</h1>
    <!-- SIGNUP WRAPPER [START]	-->
                ...
                <div class="col-lg-5 col-md-7 col-sm-9 center-col signup-box-col">
                    ...
                    <form id="my-register-form"  method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label for="firstname" style="display: none;">{{ trans('content.register.first_name') }}</label>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label for="lastname" style="display: none;">{{ trans('content.register.last_name') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select id="Gender" title="Gender" name="gender" class="form-control">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label for="email" style="display: none;">{{ trans('content.register.email') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label for="birth_year" style="display: none;">{{ trans('content.register.birth_year') }}</label>
                                    <select title="{{ trans('content.register.birth_year') }}" class="form-control" name="birthday" id="birth_year">
                                        <option value="" selected>{{ trans('content.register.birth_year') }} </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label for="username" style="display: none;">{{ trans('content.register.username') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label for="country" style="display: none;">{{ trans('content.register.country') }}</label>
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <div class="form-group">
                                    <input name="password" id="password" type="password" class="form-control" placeholder="{{ trans('content.register.password') }}" required />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-11 col-sm-11 col-xs-10 center-col">
                                <div class="checkbox">
                                    <label>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <button type="submit" class="btn btn-block btn-awaanbluebtn btn-signup">{{ trans('content.register.register') }}</button>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-6">
...
@section("additional_scripts")
    ...
    <script type="text/javascript">
        jQuery(document).ready( function() {
            ...
            var randomNr2 = 0;
            var totalNr = 0;
            var input = $('#my-register-form').find('#ebcaptchainput');
            var label = $('#my-register-form').find('#ebcaptchatext');
            ...
            $("#my-register-form").submit(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{Request::url()}}",
                    data: $("#my-register-form").serialize(), // serializes the form's elements.
