...
@section('title', trans('content.pagetitle.premium.subscribe'))
            ...
            <div class="row account">
                <div class="col-md-3 hidden-xs hidden-sm">
                    <h4 class="premium-fees" style="display: none">
                        <span class="premium-price"> 30 </span> <span class="premium-currency"> AED </span> <span data-i18n="premium.per">  {{ trans('content.premiumsubscribe.permonth') }} </span></h4>
                </div>
                <div class="col-md-9 ">
                    ...
                    <ul class="nav nav-justified subscribe_nav">
                        ...
                        <li><a data-toggle="tooltip" data-placement="top" title="UAE" style="background: transparent;" href="#" class="setOperator" data-currency="AED" data-currencytext="30" data-operatorcode="971" data-provider="Etisalat,Du" data-logo="/images/gateways/ae.png">
                                <img class="img-rounded" src="/images/gateways/ae.png"></a></li>

                        <li><a data-toggle="tooltip" data-placement="top" title="KSA" style="background: transparent;" href="#" class="setOperator" data-currency="SAR" data-currencytext="50" data-operatorcode="966" data-provider="Zain,Mobily,STC" data-logo="/images/gateways/sa.png">
                                <img class="img-rounded" src="/images/gateways/sa.png"></a></li>

                        <li><a  data-toggle="tooltip" data-placement="top" title="Egypt" style="background: transparent;" href="#" class="setOperator" data-currency="EGP" data-currencytext="35" data-operatorcode="20" data-provider="Vodafone,Orange" data-logo="/images/gateways/eg.png">
                                <img class="img-rounded" src="/images/gateways/eg.png"></a></li>

                        <li><a data-toggle="tooltip" data-placement="top" title="Palestine" style="background: transparent;" href="#" class="setOperator" data-currency="ILS" data-currencytext="30" data-operatorcode="97" data-provider="Jawwal,Watanyia" data-logo="/images/gateways/ep.png">
                                <img class="img-rounded" src="/images/gateways/ep.png"></a></li>


                        <li><a data-toggle="tooltip" data-placement="top" title="Jordan" style="background: transparent;" href="#" class="setOperator" data-currency="JOD" data-currencytext="5" data-operatorcode="962" data-provider="Zain,Orange,Umniah" data-logo="/images/gateways/jo.png">
                                <img class="img-rounded" src="/images/gateways/jo.png"></a></li>


                        <li><a data-toggle="tooltip" data-placement="top" title="Qatar" style="background: transparent;" href="#" class="setOperator" data-currency="QAR" data-currencytext="50" data-operatorcode="974" data-provider="Ooredoo" data-logo="/images/gateways/qa.png">
                                <img class="img-rounded" src="/images/gateways/qa.png"></a></li>


                        <li><a data-toggle="tooltip" data-placement="top" title="Kuwait" style="background: transparent;" href="#" class="setOperator" data-currency="KWD" data-currencytext="2" data-operatorcode="965" data-provider="Viva,Ooredoo" data-logo="/images/gateways/kw.png">
                                <img class="img-rounded" src="/images/gateways/kw.png"></a></li>


                        <li><a data-toggle="tooltip" data-placement="top" title="Bahrain" style="background: transparent;" href="#" class="setOperator" data-currency="BHD" data-currencytext="5" data-operatorcode="973" data-provider="Viva,Zain" data-logo="/images/gateways/bh.png">
                                <img class="img-rounded" src="/images/gateways/bh.png"></a></li>

                        <li><a data-toggle="tooltip" data-placement="top" title="Iraq" style="background: transparent;" href="#" class="setOperator" data-currency="IQD" data-currencytext="7800" data-operatorcode="964" data-provider="Zain" data-logo="/images/gateways/iraq.png">
                                <img class="img-rounded" src="/images/gateways/iraq.png"></a></li>

                        <li><a data-toggle="tooltip" data-placement="top" title="Tunisia" style="background: transparent;" href="#" class="setOperator" data-currency="TND" data-currencytext="28" data-operatorcode="216" data-provider="Orange" data-logo="images/gateways/tn.png">
                    ...
                    <div class="provider_board" style="display: none">
                        ...
                        <p class="sub-text" data-i18n="account.subscribe_step_one.description_2">{{ trans('content.premiumsubscribe.description_2') }}</p>
                    </div>
                </div>
            </div>
        </div>
